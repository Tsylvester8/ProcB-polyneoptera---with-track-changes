...
\keywords{fusion, fission, chromosome number, sex chromosome, Polyneoptera, karyotype, genome size}
...
\maketitle
\noindent
start, consistent rules governing the evolution of chromosome number across large clades remain elusive.
...
Briefly, if transitions from XO to XY are generated by the fusion of an autosome to a sex chromosome we would expect a lower mean autosome number for XY species. %mention losses as possibility in discussion
...
The transition between SCSs from XO to XY can occur through X chromosome autosome fusions or by sex chromosome turnover with fixation of the ancestral X as an autosome\textcolor{blue}{\cite{charlesworth1980, white1973, vicoso2015}}. %HB add vicoso and bachtrog 2015
...
The recent development of a null model for fusions that facilitates testing for an excess of sex chromosome autosome fusions is an obvious next step that could be applied in groups like Orthoptera and Phasmatodea \cite{anderson2020}. %HB citation to Nathan's paper
...
With respect to sex chromosome systems Mantodea, Orthoptera and Phasmatodea had all previously been hypothesized to originate from XO ancestors and our results confirm these hypotheses \cite{hughes1950chromosomes,blackmon2016, blackman1995sex}. % TS: added information on the support for common origin of the XO sex chromosome system in Polyneoptera. - reply for R2.8
...
However, other work using different methods has shown that the X chromosome in \textit{Drosphila melanogaster} is not homologous to the Z in \textit{Bombyx mori} or \textit{Tribolium castaneum} suggesting that insects may have frequent turnover in sex chromosome systems \cite{pease2012}.%HB cite hahn 
...
Although we do not find a significant difference between the rates of fusion and rates of fission (Table S5), in our ancestral state analysis for chromosome number, we find that the average number of fusion events are higher than number of fission events (33.32 fusion events and 21.94 fission events).} %HB are these significantly different - TP: yes these values are significantly different
...
\hline
\multicolumn{1}{c}{\multirow{2}{*}{order}} &
  \multicolumn{1}{c}{\multirow{2}{*}{genera}} &
  \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Mean number of\\  autosomes (haploid count)\end{tabular}} &
  \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Evidence \\ supports\end{tabular}} &
  \multicolumn{3}{c}{\begin{tabular}[c]{@{}c@{}}Mean number of \\ chromosomes (diploid count)\end{tabular}} &
  \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Evidence \\ supports\end{tabular}} \\ \cline{3-4} \cline{6-8}
\multicolumn{1}{c}{} & \multicolumn{1}{c}{}         & XO   & XY   &        & XY   & multi (female) & multi (male) &         \\ \hline
Dermaptera           & \textit{Forficula (14)}      &      & 11   &        & 24   & 25.3           & 24           & -       \\
Dermaptera           & \textit{Nala (3)}            &      & 17.5 &        & 37   & 38             & 37           & -       \\
Dermaptera           & \textit{Nesogaster (2)}      & 10   &      &        &      & 22             & 21           &         \\
Mantodea             & \textit{Deiphobe (2)}        & 9    &      &        &      & 28             & 27           &         \\
Orthoptera           & \textit{Aleuas (6)}          & 9    & 9.2  & -      & 20.4 &                &              &         \\
Orthoptera           & \textit{Dichroplus (35)}     & 10.7 & 8.7  & fusion & 19.4 & 22             & 21           & fission \\
Orthoptera           & \textit{Diponthus (7)}       & 10.5 & 10   & fusion & 22   &                &              &         \\
Orthoptera           & \textit{Eurotettix (5)}      &      & 10   &        & 22   & 22             & 21           & -       \\
