...
The first, using all available data (N=XXXX) was not phylogenetically corrected, and was fit with the lm function in R.
The second, used the subset of data which could be mapped to our phylogeny (N=XXXX), and was fit with the phylolm function in the package phylolm which allows us to account for phylogenetic history \cite{R-citation, phylolm}.}
