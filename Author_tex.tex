...
Chromosomal heterozygosity occurs when the chromosome \textcolor{red}{\st{compliment}} \textcolor{blue}{complement} from the parents differs.
...
\textcolor{blue}{We used the lm function in base R to construct a liner model without correcting for phylogeny and the function phylolm in the package phylolm to construct a linear model with the phylogenetic correction}
...
This is consistent with rate estimates for Isoptera in isolation, where we infer a mean fusion rate of 0.044, a fission rate of \textcolor{red}{\st{0.063 and a polyploidy rate}} \textcolor{blue}{0.063, and a polyploidy rate} of 0.003.
...
The transition between SCSs from XO to XY can occur through X chromosome autosome fusions or by sex chromosome turnover with fixation of the ancestral X as a new autosome\textcolor{blue}{\cite{charlesworth1980, white1973}}.
