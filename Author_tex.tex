...
Genome size data were available for 185 Polyneoptera species in the orders Phasmatodea, Orthoptera, Mantodea, and Blattodea (including Isoptera) in the genome size data base. We added additional 60 new genome size estimates to this existing dataset. These new estimates are now reported in Table S3.
...
\multirow{2}{*}{Order} &
  ...
  \multirow{2}{*}{supports} \\ \cline{3-4} \cline{6-7}
